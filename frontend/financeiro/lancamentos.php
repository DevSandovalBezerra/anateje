...
<div class="cadastros-content" data-perfil="<?php echo $_SESSION['perfil_id'] ?? 0; ?>" data-unidade="<?php echo $_SESSION['unidade_id'] ?? ''; ?>">
    <div class="mb-6 flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-semibold text-secondary-black">Lançamentos Financeiros</h1>
            <p class="text-secondary-dark-gray mt-1 max-w-3xl">
                Gerencie receitas e despesas com parcelamento, recorrência e ações em massa.
            </p>
        </div>
        ...
        <div class="flex flex-wrap gap-4">
            ...
            <div class="flex-1 min-w-64">
                ...
                <div class="relative">
                    ...
                    <input type="text" id="inputBuscar" placeholder="Título, descrição..." class="input-primary pl-10">
                </div>
            </div>
            ...
            <table class="min-w-full">
                <thead class="bg-secondary-light-gray">
                    <tr>
                        ...
                        <th class="px-4 py-2 text-left text-xs font-medium text-secondary-dark-gray uppercase">Título</th>
