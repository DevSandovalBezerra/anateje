            ...
            <div class="overflow-x-auto">
                <table class="min-w-full">
                    ...
                    <tbody class="divide-y divide-secondary-gray">
                        <tr>
                            <td class="px-4 py-2 text-sm font-medium text-secondary-black">PAG-2025-0001</td>
                            <td class="px-4 py-2">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-secondary-dark-gray">Carlos Alves</p>
                                    </div>
                                </div>
                            </td>
                            <td class="px-4 py-2 text-sm font-medium text-secondary-black">R$ 150,00</td>
                            <td class="px-4 py-2 text-sm text-secondary-dark-gray">22/10/2025</td>
                            <td class="px-4 py-2">
                                <span class="badge-success">Pago</span>
                            </td>
                            <td class="px-4 py-2">
                                <div class="flex space-x-2">
                                    <button class="text-purple-600 hover:text-purple-700" title="Baixar">
                        ...
                        <tr>
                            <td class="px-4 py-2 text-sm font-medium text-secondary-black">PAG-2025-0002</td>
                            <td class="px-4 py-2">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-secondary-dark-gray">Maria Silva</p>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td class="px-4 py-2 text-sm font-medium text-secondary-black">PAG-2025-0003</td>
                            <td class="px-4 py-2">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-secondary-dark-gray">Pedro Oliveira</p>
                                    </div>
                                </div>
                            </td>
                            <td class="px-4 py-2 text-sm font-medium text-secondary-black">R$ 1.200,00</td>
                            <td class="px-4 py-2 text-sm text-secondary-dark-gray">15/10/2025</td>
                            <td class="px-4 py-2">
                                <span class="badge-error">Vencido</span>
                            </td>
                            <td class="px-4 py-2">
                                <div class="flex space-x-2">
                                    <button class="text-purple-600 hover:text-purple-700" title="Baixar">
